...
uint256 hashGenesisBlock("0x9a73f76a82b88a6f34dfc8410aeca98a043226335da9556e13f1c7242394fbd1");
...
const string strMessageMagic = "eternalcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 1 * 30 * 60; // eternalcoin: 30 mins
static const int64 nTargetSpacing = 180; // eternalcoin: 3 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal eternalcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "eternalcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x141775b9f83bd3c3650b5c6b582b57dfa3bb6bc624acba8d45f130543067c74b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Toronto Mayor smokes crack";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389259730; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 563857;

        if (fTestNet)
        {
            block.nTime    = 1389234477;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf26ffbaca85cd5cc101ed1385c4514f390c0dc403cb139c337a56706389e6210"));
